...
- 创建和编辑 public beta plot kinds 和内置 statistics recipes：mean/SEM lines、mean/SEM bars、count bars、stacked count bars、grouped points、category boxplots、category violins、paired before/after panels、ECDF distributions，以及 bundled experimental neuro core/ephys timecourses。
