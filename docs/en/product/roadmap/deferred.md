...
| Full Matplotlib artist coverage, including every custom artist, 3D, polar plots, animation, or browser-native interactive publishing | Full artist coverage would dilute support for reproducible publication panels. | High-demand artist families can be supported through clear, testable contracts. |
