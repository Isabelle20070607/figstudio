...
- Create and edit the public beta plot kinds and bundled statistics recipes: mean/SEM lines, mean/SEM bars, count bars, grouped points, and paired before/after panels.
