...
Supported `RecipeLayer.kind` values are `mean_sem_line`, `mean_sem_bar`, `count_bar`, `stacked_bar`, `boxplot_by_category`, `grouped_points`, and `paired_before_after`.
