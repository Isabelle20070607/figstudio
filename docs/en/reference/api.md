...
Supported `RecipeLayer.kind` values are `mean_sem_line`, `mean_sem_bar`, `count_bar`, `stacked_bar`, `boxplot_by_category`, `violin_by_category`, `grouped_points`, `paired_before_after`, `ecdf`, and `neuro.ephys.event_rate_timecourse`.
