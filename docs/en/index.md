# FigStudio Documentation

FigStudio is for scientific Python users who already have data in a script or notebook and need a faster path to reproducible, publication-ready Matplotlib figures.
...
3. [Gallery](gallery.md): inspect checked-in workflows for facets, category boxplots, category violins, ECDF distributions, stacked bars, bundled neuro recipes, secondary axes, GridSpec spans, reference lines, and reusable specs.
...
| Need | Page |
| --- | --- |
| Python, CLI, REST, and FigureSpec contracts | [API Reference](reference/api.md) |
| Checked-in example workflows | [Gallery](gallery.md) |
